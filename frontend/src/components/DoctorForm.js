  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input
        ...
        onChange={(e) =>
          setAdditionalData({ ...additionalData, specialty: e.target.value })
        }
      />
      <input
        type="text"
        placeholder="Registro"
        value={additionalData.register}
        onChange={(e) =>
          setAdditionalData({ ...additionalData, register: e.target.value })
        }
      />
      <input
        type="text"
        placeholder="Convênios Aceitos"
        value={additionalData.acceptedHealthInsurance}
        onChange={(e) =>
          setAdditionalData({
            ...additionalData,
            acceptedHealthInsurance: e.target.value,
          })
        }
      />
